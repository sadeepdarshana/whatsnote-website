...
async function loadPDF() {
    let pdf = getParameterByName('pdf')
    let content = await readArrayBufferFromFile(pdf);
    console.log(content);
    window.PDFViewerApplication.open(content);
}
...
var PDFViewerApplication = {
    ...
    if (_app_options.AppOptions.get('pdfBugEnabled')) {
      ...
      if ('textlayer' in hashParams) {
        switch (hashParams['textlayer']) {
          ...
          case 'shadow':
          case 'hover':
            var viewer = this.appConfig.viewerContainer;
  ...
  _initializeViewerComponents: function _initializeViewerComponents() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var dispatchToDOM = _app_options.AppOptions.get('eventBusDispatchToDOM');
      var eventBus = appConfig.eventBus || (0, _dom_events.getGlobalEventBus)(dispatchToDOM);
...
var EventBus = function () {
  function EventBus() {
    var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        dispatchToDOM = _ref3$dispatchToDOM === undefined ? false : _ref3$dispatchToDOM;
...
var BasePreferences = function () {
  ...
  _createClass(BasePreferences, [{
    ...
    value: function set(name, value) {
      ...
      return this._initializedPromise.then(function () {
        if (_this3.defaults[name] === undefined) {
          throw new Error("Set preference: \"" + name + "\" is undefined.");
        } else if (value === undefined) {
          throw new Error('Set preference: no value is specified.');
        }
        var valueType = typeof value === "undefined" ? "undefined" : _typeof(value);
        var defaultType = _typeof(_this3.defaults[name]);
        ...
        _this3.prefs[name] = value;
        return _this3._writeToStorage(_this3.prefs);
      });
    }
  }, {
    key: "get",
    value: function get(name) {
      ...
      return this._initializedPromise.then(function () {
        var defaultValue = _this4.defaults[name];
        if (defaultValue === undefined) {
          throw new Error("Get preference: \"" + name + "\" is undefined.");
        } else {
          var prefValue = _this4.prefs[name];
    ...
    value: function getAll() {
      ...
      return this._initializedPromise.then(function () {
        return Object.assign(Object.create(null), _this5.defaults, _this5.prefs);
      });
    }
  }]);
...
function readArrayBufferFromFile(contentName){
